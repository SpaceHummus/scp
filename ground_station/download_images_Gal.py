...
if len(sys.argv)==7:
    ...
    start_date2 = start_date[0] + ":" + start_date[1] + ":" + start_date[2] + ":" + start_date[3] + ":" + start_date[4] + ":"
    print(start_date2)
    start_date_new = datetime.strptime(start_date2,"%y-%m-%d__%H_%M")
    end_date = sys.argv[3]
